            ...
            <div class="flex flex-col items-center justify-center">
                ...
                <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, color-mix(in srgb, var(--primary-color), transparent 60%) 10%, var(--surface-ground) 30%)">
                    <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20 flex flex-col items-center" style="border-radius: 53px">
                        <span class="text-primary font-bold text-3xl">{{ 'components.error.CODE' | translate }}</span>
                        <h1 class="text-surface-900 dark:text-surface-0 font-bold text-3xl lg:text-5xl mb-2">{{ 'components.error.TITLE' | translate }}</h1>
                        <div class="text-surface-600 dark:text-surface-200 mb-8">{{ 'components.error.MESSAGE' | translate }}</div>
                        <a routerLink="/" class="w-full flex items-center py-8 border-surface-300 dark:border-surface-500 border-b">
                            ...
                            <span class="ml-6 flex flex-col">
                                <span class="text-surface-900 dark:text-surface-0 lg:text-xl font-medium mb-0 block">{{ 'components.error.FAQ_TITLE' | translate }}</span>
                                <span class="text-surface-600 dark:text-surface-200 lg:text-xl">{{ 'components.error.FAQ_SUB' | translate }}</span>
                            </span>
                        </a>
                        <a routerLink="/" class="w-full flex items-center py-8 border-surface-300 dark:border-surface-500 border-b">
                            <span class="flex justify-center items-center border-2 border-primary text-primary rounded-border" style="height: 3.5rem; width: 3.5rem">
                            ...
                            <span class="ml-6 flex flex-col">
                                <span class="text-surface-900 dark:text-surface-0 lg:text-xl font-medium mb-0">{{ 'components.error.SOLUTION_TITLE' | translate }}</span>
                                <span class="text-surface-600 dark:text-surface-200 lg:text-xl">{{ 'components.error.SOLUTION_SUB' | translate }}</span>
                            </span>
                        </a>
                        <a routerLink="/" class="w-full flex items-center mb-8 py-8 border-surface-300 dark:border-surface-500 border-b">
                            ...
                            <span class="ml-6 flex flex-col">
                                <span class="text-surface-900 dark:text-surface-0 lg:text-xl font-medium mb-0">{{ 'components.error.PERMISSION_TITLE' | translate }}</span>
                                <span class="text-surface-600 dark:text-surface-200 lg:text-xl">{{ 'components.error.PERMISSION_SUB' | translate }}</span>
                            </span>
                        </a>
                        <p-button [label]="('components.error.GO_DASHBOARD' | translate)" routerLink="/" />
                    </div>
                </div>
            </div>
        </div>
