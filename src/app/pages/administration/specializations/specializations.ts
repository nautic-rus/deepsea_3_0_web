...
export class AdminSpecializationsComponent implements OnInit {
 ...
 const headers = [
 'ID',
 this.translate.instant('components.permissions.table.HEADERS.NAME') || 'Name', // TODO: make reactive (refresh on translate.onLangChange)
 this.translate.instant('components.permissions.table.HEADERS.CODE') || 'Code', // TODO: make reactive (refresh on translate.onLangChange)
 this.translate.instant('components.permissions.table.HEADERS.DESCRIPTION') || 'Description', // TODO: make reactive (refresh on translate.onLangChange)
 this.translate.instant('components.permissions.table.HEADERS.CREATED_AT') || 'Created At' // TODO: make reactive (refresh on translate.onLangChange)
 ];

 const esc = (v: any) => {
 if (v === null || v === undefined) return '';
 if (typeof v === 'boolean') return v ? (this.translate.instant('MENU.ACTIVE_YES') || 'Active') : (this.translate.instant('MENU.ACTIVE_NO') || 'Inactive'); // TODO: make reactive (refresh on translate.onLangChange)
 const s = String(v);
 return '"' + s.replace(/"/g, '""') + '"';
 };
 ...
 if (!name) {
 this.formErrors.name = (this.translate.instant('components.permissions.form.NAME') || 'Name') + ' is required'; // TODO: make reactive (refresh on translate.onLangChange)
 }
 if (!code) {
 this.formErrors.code = (this.translate.instant('components.permissions.form.CODE') || 'Code') + ' is required'; // TODO: make reactive (refresh on translate.onLangChange)
 }
