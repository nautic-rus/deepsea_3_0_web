...
export class AdminPermissionsComponent implements OnInit {
  ...
  message: `${this.translate.instant('components.permissions.confirm.DELETE_QUESTION') || 'Delete item'} "${item.name || item.id}"?`, // TODO: make reactive (refresh on translate.onLangChange)
  ...
  if (!code) this.formErrors.code = (this.translate.instant('components.permissions.form.CODE') || 'Code') + ' is required'; // TODO: make reactive (refresh on translate.onLangChange)
    this.safeDetect();
