...
function D(t2, e, o = true) {
  var n2, r, i3, l3;
  if (t2) {
    let d3 = t2.offsetParent ? { width: t2.offsetWidth, height: t2.offsetHeight } : w2(t2), s4 = d3.height, a2 = d3.width, u2 = e.offsetHeight, p3 = e.offsetWidth, f2 = e.getBoundingClientRect(), g3 = $2(), it = k2(), lt = h(), L, N2, ot = "top";
    f2.top + u2 + s4 > lt.height ? (L = f2.top + g3 - s4, ot = "bottom", L < 0 && (L = g3)) : L = u2 + f2.top + g3, f2.left + a2 > lt.width ? N2 = Math.max(0, f2.left + it + p3 - a2) : N2 = f2.left + it, V(t2) ? t2.style.insetInlineEnd = N2 + "px" : t2.style.insetInlineStart = N2 + "px", t2.style.top = L + "px", t2.style.transformOrigin = ot, o && (t2.style.marginTop = ot === "bottom" ? `calc(${(r = (n2 = x(/-anchor-gutter$/)) == null ? void 0 : n2.value) != null ? r : "2px"} * -1)` : (l3 = (i3 = x(/-anchor-gutter$/)) == null ? void 0 : i3.value) != null ? l3 : "");
  }
}
function S(t2, e) {
...
function I(t2, e, o = true, n2 = void 0) {
  var r;
  if (t2) {
    let i3 = t2.offsetParent ? { width: t2.offsetWidth, height: t2.offsetHeight } : w2(t2), l3 = e.offsetHeight, d3 = e.getBoundingClientRect(), s4 = h(), a2, u2, p3 = n2 != null ? n2 : "top";
...
//# sourceMappingURL=chunk-E6DYHV74.js.map
